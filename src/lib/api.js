...
export const organizationsApi = {
  ...
  getDomains: (id) => api.get(`/organizations/${id}/domains`),
  create: (data) => api.post("/organizations", data),
  update: (id, data) => api.put(`/organizations/${id}`, data),
  updateDomains: (id, data) => api.put(`/organizations/${id}/domains`, data),
...
export const subscriptionsApi = {
  ...
  getQuota: (id) => api.get(`/subscriptions/${id}/quota`),
  updateQuota: (id, data) => api.put(`/subscriptions/${id}/quota`, data),
  updateUsageQuota: (id, data) => api.put(`/subscriptions/${id}/usage-quota`, data),
...
export const billingApi = {
  ...
  getInvoiceRecipients: (id) => api.get(`/billing/${id}/email-recipients`),
  sendInvoiceEmail: (id, emails) => api.post(`/billing/${id}/send-email`, { emails }),
...
export const notificationsApi = {
  ...
  createGroupEmail: (data) => api.post("/notifications/group-emails", data),
  updateGroupEmail: (id, data) => api.put(`/notifications/group-emails/${id}`, data),
  deleteGroupEmail: (id) => api.delete(`/notifications/group-emails/${id}`),
